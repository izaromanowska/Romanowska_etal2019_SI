...
;;authors names removed for peer review. Agent-based Modeling for Archaeologists.
;; A step-by-step guide for using agent-based modeling in archaeological research (Part I of III)
;;Submitted May 2018 to Advances in Archaeological Practice.

;;Additional materials can be found at REPO HERE- name removed for peer review
...
; _________________ 1. Environment Setup _________________
  ...
  ask patches[
   ...
   let r 1
   ask n-of 2500 patches [	; 2500 random patches become raw material sources
      set source? true		; set the variable source? as true
      set material_type r	; each will have a different raw material type
      set r r + 1			; marked as a number between 1 and 2500
      set pcolor black
  ]
   ...
   ask turtles [
     ...
     ;_________________ 2. Drop a random item from the toolkit _________________
      ...
      if [ source? ] of patch-here = true [	; if you come across a patch with raw material
        let rm [ material_type ] of patch-here	; determine the type of raw material
        while [ length toolkit < max_carry ] [	; while you still have capacity to carry more...
          set toolkit fput rm toolkit		; keep on adding that raw material to your toolkit
        ]
      ]
    ]
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot [ length (remove-duplicates toolkit) ] of turtle 0 "
